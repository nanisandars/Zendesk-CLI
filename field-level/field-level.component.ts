...
export class FieldLevelComponent implements OnInit {
  ...
  userName: string;
    ...
    GetExceptions() {
        var that = this;
        this.exception.GetExceptions(this.userName, this.IntegrationType, 'FieldLevel', this.FilterDays).subscribe(
            data=> {
